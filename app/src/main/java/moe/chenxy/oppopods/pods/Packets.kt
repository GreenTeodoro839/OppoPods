...
object Cmd {
    ...
    const val REGISTER_MULTI_NOTIFICATION_RESPONSE = 0x8205
}
 ...
 * Returns the raw ID bytes so the caller can subscribe to all of them via
 * [Enums.registerMultiNotification]. Without this echo-all subscribe the bud
 * won't push the smart-mode current-strength notification (cmd 0x0204 type 03
 * key 04) that [SmartAncLevelParser] reads.
 */
